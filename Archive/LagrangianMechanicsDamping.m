...
syms EQNmotionT1 EQNmotionT2 b

% Note, Eqns of motion are given by EQNmotionT1 = 0 and EQNmotionT2 = 0

EQNmotionT1 = dt_wrt_dL_wrt_dotT1 - dL_wrt_T1 + b*diff(Theta1);
EQNmotionT1 = expand(EQNmotionT1);
EQNmotionT1 = simplify(EQNmotionT1)

EQNmotionT2 = dt_wrt_dL_wrt_dotT2 - dL_wrt_T2 + b*diff(Theta2);
EQNmotionT2 = expand(EQNmotionT2);
EQNmotionT2 = simplify(EQNmotionT2)

EQNmotionT3 = dt_wrt_dL_wrt_dotT3 - dL_wrt_T3 + b*diff(Theta3);
