...
m1 = 0.04;                            % magnitude of magnetic moment of point 1
m2 = 0.04;                            % magnitude of magnetic moment of point 2
m3 = 0.04;                            % magnitude of magnetic moment of point 3
m4 = 0.04;                            % magnitude of magnetic moment of point 3
...
B = [0,25e-1];                         % Magnetic field strength in Tesla (25 mT) in +y direction
...
for step = 1:Iterations
    ...
    % Calculate Magnetic Moment
    m2_Vector = m2 * m2_dir; % m1 magnitude along Link1's direction
    ...
    % Calculate current velocity
    Velocity2 = Velocity2 + (acceleration2 - DampingFactor * Velocity2) * dt;
    ...
    % Calculate Magnetic Moment
    m3_Vector = m3 * m3_dir; % m1 magnitude along Link1's direction
    ...
    % Calculate current velocity
    Velocity3 = Velocity3 + (acceleration3 - DampingFactor * Velocity3) * dt;
    ...
    % Calculate Magnetic Moment
    m4_Vector = m4 * m4_dir; % m1 magnitude along Link1's direction
    ...
    % Calculate current velocity
    Velocity4 = Velocity4 + (acceleration4 - DampingFactor * Velocity4) * dt;
...
video = VideoWriter('DualMaterial3.avi');
video.FrameRate = 10;
open(video);
